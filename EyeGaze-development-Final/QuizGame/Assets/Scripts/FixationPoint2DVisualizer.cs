...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class FixationPoint2DVisualizer : MonoBehaviour
    {
        ...
        UnityEngine.InputSystem.XR.Eyes blinkChecker;
        Canvas m_Canvas;
        ARFace m_Face;
        ...
        void OnUpdated(ARFaceUpdatedEventArgs eventArgs)
        {
            ...
            if (blinkChecker.leftEyeOpenAmount == 0 && blinkChecker.rightEyeOpenAmount == 0)
            {
                Blink();
            }
        }
        ...
        IEnumerator Blink()
        {
            ...
            if(blinkChecker.leftEyeOpenAmount == 0 && blinkChecker.rightEyeOpenAmount == 0)
            {
                if (m_FixationReticleGameObject.GetComponent<RectTransform>().anchoredPosition3D == trueButton.GetComponent<RectTransform>().anchoredPosition3D)
                    trueButton.onClick.Invoke();
                else if (m_FixationReticleGameObject.GetComponent<RectTransform>().anchoredPosition3D == falseButton.GetComponent<RectTransform>().anchoredPosition3D)
